defmodule Metnum.RootTest do
  ...
  describe "#newton_raphson/3" do
    test "1 variable function" do
      ...
      assert equal_within_epsilon(func1_root_seq1[epochs1], Nx.sqrt(3))
      assert equal_within_epsilon(func1_root_seq2[epochs1], Nx.negate(Nx.sqrt(3)))

      epochs2 = 10
      func2_root_seq1 = R.newton_raphson(func2, 0, epochs2)
      func2_root_seq2 = R.newton_raphson(func2, -1, epochs2)

      assert equal_within_epsilon(func2_root_seq1[epochs2], 1)
      assert equal_within_epsilon(func2_root_seq2[epochs2], -2)
    end
  end
end
